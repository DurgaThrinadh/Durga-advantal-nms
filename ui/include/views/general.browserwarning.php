	...
	<div class="<?= ZBX_STYLE_LAYOUT_WRAPPER ?>">
		<main>
			<div class="<?= ZBX_STYLE_BROWSER_WARNING_CONTAINER ?>">
				...
				<ul>
					<li>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.google.com/chrome">
							<div class="<?= ZBX_STYLE_BROWSER_LOGO_CHROME ?>"></div>
						</a>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.google.com/chrome">Google Chrome</a>
					</li>
					<li>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.mozilla.org/firefox">
							<div class="<?= ZBX_STYLE_BROWSER_LOGO_FF ?>"></div>
						</a>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.mozilla.org/firefox">Mozilla Firefox</a>
					</li>
					<li>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="https://www.microsoft.com/en-us/edge">
							<div class="<?= ZBX_STYLE_BROWSER_LOGO_ED ?>"></div>
						</a>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="https://www.microsoft.com/en-us/edge">Microsoft Edge</a>
					</li>
					<li>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.opera.com/download">
							<div class="<?= ZBX_STYLE_BROWSER_LOGO_OPERA ?>"></div>
						</a>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.opera.com/download">Opera browser</a>
					</li>
					<li>
						<a target="_blank" rel="noopener<?= ZBX_NOREFERER ? ' noreferrer' : '' ?>" href="http://www.apple.com/safari/download">
							<div class="<?= ZBX_STYLE_BROWSER_LOGO_SAFARI ?>"></div>
						</a>
