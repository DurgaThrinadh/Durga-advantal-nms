...
class Actions
{
	...
	public static function load()
	{
		...
		DBexecute(
			'INSERT INTO events (eventid, source, object, objectid, clock, value, acknowledged, ns) VALUES ' .
				' (101, 0, 0, 13545, 1329724790, 1, 0, 0);'
		);

		DBexecute(
			'INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject, ' .
